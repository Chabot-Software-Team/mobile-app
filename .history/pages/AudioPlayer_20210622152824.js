    ...
    <View style={{ flex: 1 }}>
      ...
      >
        ...
        <View style={{ flex: 20 }}>
          ...
          <Slider value = {sliderValue} onValueChange = {(sliderValue) =>setSliderValue(sliderValue)} minimumValue={0} maximumValue={isLoaded ? status.durationMillis : 1} thumbTintColor='#04A5BA'/>
        </View>
        <View style={{ flex: 1 }}></View>
      </View>
