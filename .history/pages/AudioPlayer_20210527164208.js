    ...
    <View style={{ flex: 1 }}>
      ...
      >
        ...
        <View style={{ flex: 20 }}>
          ...
          <Slider value = {sliderValue} onValueChange = {(sliderValue) =>setSliderValue(sliderValue)} minimumValue={0} maximumValue={1} thumbTintColor='#04A5BA' />
